...
LyraDB 当前定位为“可私有化的可信 AI 数据智库”。涉及产品名称、用户文案、AI 能力或路线图的修改，必须遵守 [产品定位](docs/product/产品定位.md) 和 [品牌规范](docs/品牌与信息规范.md)，并区分已实现、已验证、默认开放与规划。

数据库工作台是人类专业控制面；贡献不得把模型建议改造成未经确认的数据库行动，也不得绕过权限、成本、审核和审计边界。
